...
function initFrameDifferencing(){
	...
	material1 = new THREE.ShaderMaterial({
		...
		fragmentShader: document.getElementById("contrastFrag").textContent
	});
	...
	materialDiff = new THREE.ShaderMaterial({
		uniforms: {
			time: { type: 'f' , value: time},
			resolution: {type: 'v2', value: new THREE.Vector2(w,h)},
			texture3: {type: 't', value: rt1},
			texture2: {type: 't', value: rt2},
			texture: {type: 't', value: camTex} 
		},
		vertexShader: document.getElementById("vs").textContent,
		fragmentShader: document.getElementById("reposFrag").textContent
	});
	...
	materialFB = new THREE.ShaderMaterial({
		...
		vertexShader: document.getElementById("vs").textContent,
		fragmentShader: document.getElementById("flowFrag").textContent
	});
